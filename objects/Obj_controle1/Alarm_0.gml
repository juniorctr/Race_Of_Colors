...
var faixa_x = irandom_range(140, 355);
...
if (segundos mod 30 == 0) {
    ...
    if (indice < array_length(sequencia_faixas)) {
        ...
        var f = instance_create_layer(250, -390, "Instances", faixa_color);
        f.vspeed = 8;

        // Ajusta o tamanho da faixa 
        f.image_xscale = 520 / sprite_get_width(f.sprite_index);
        f.image_yscale = 350 / sprite_get_height(f.sprite_index);
    }
}
